from repositorios.rol_repositorio import RepositorioRolPostgreSQL
from servicios.conexion.proveedor_conexion import get_proveedor_conexion

# ✅ Esta clase debe llamarse EXACTAMENTE RolServicio
class RolServicio:
    def __init__(self):
        proveedor = get_proveedor_conexion()
        self._repo = RepositorioRolPostgreSQL(proveedor.obtener_cadena_conexion())
